...
.sm-scope .sm-panel-item { position: relative; color: #07518a; font-weight: 400; font-size: 1.5rem; cursor: pointer; line-height: 1.5; letter-spacing: -2px; text-transform: uppercase; transition: background 0.25s, color 0.25s; display: inline-block; text-decoration: none; padding-right: 5em; }
...
@media (max-width: 640px) { .sm-scope .staggered-menu-panel { width: 100%; left: 0; right: 0; } .sm-scope .staggered-menu-wrapper[data-open] .sm-logo-img { filter: invert(100%); }   height: 100dvh; /* 🔥 mobile safe */
  overflow-y: auto;
