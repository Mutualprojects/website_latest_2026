...
export function NeonOrbs() {
  ...
  .beam-light {
    ...
    background: linear-gradient(
      90deg,
      transparent 0%,
      rgba(7, 81, 138, 0.4) 30%,
      rgba(7, 81, 138, 0.8) 70%,
      rgba(7, 81, 138, 1) 100%
    );

    box-shadow: 
      0 0 20px 4px rgba(7, 81, 138, 0.6),
      0 0 40px 8px rgba(7, 81, 138, 0.3);
  }
  ...
  .dark .beam-light {
    background: linear-gradient(
      90deg,
      transparent 0%,
      rgba(7, 81, 138, 0.5) 30%,
      rgba(120, 180, 255, 0.9) 70%,
      rgba(180, 220, 255, 1) 100%
    );

    box-shadow: 
      0 0 20px 4px rgba(7, 81, 138, 0.8),
      0 0 40px 8px rgba(120, 180, 255, 0.4);
  }
  ...
  .orb-light {
    ...
    box-shadow: 
      0 0 60px 2px rgba(7, 81, 138, 0.3),
      0 0 100px 5px rgba(7, 81, 138, 0.15),
      inset 0 0 60px 2px rgba(7, 81, 138, 0.08);

    border: 1px solid rgba(7, 81, 138, 0.4);
  }
  ...
  .dark .orb-light {
    ...
    box-shadow: 
      0 0 60px 2px rgba(7, 81, 138, 0.5),
      0 0 100px 5px rgba(7, 81, 138, 0.25),
      inset 0 0 60px 2px rgba(7, 81, 138, 0.15);

    border: 1px solid rgba(7, 81, 138, 0.5);
  }
