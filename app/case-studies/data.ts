// src/data/caseStudiesBySector.ts
...
import ANDHARA_PRAGATHI_GRAMEENA_BANK from "./casestudyimages/Banking/andhara-pragathi-grameena-bank.png";
import ANDHRA_PRADESH_STATE_CO_OPERATIVE_BANK_Ltd from "./casestudyimages/Banking/andhra-pradesh-state-co-operative-bank-ltd.png";
import BANK_OF_BARODA from "./casestudyimages/Banking/bank-of-baroda.png";
import KARUE_VYSHYA from "./casestudyimages/Banking/karue-vyshya.png";
import TELANGANA_STATE_CO_OPERATIVE_BANK from "./casestudyimages/Banking/telangana-state-co-operative-bank.png";

/* =========================
   CONSTRUCTIONS
========================= */
import ANUHAR_HOMES_RESIDENTIAL_COMMUNITY from "./casestudyimages/CONSTRUCTIONS/anuhar-homes-residential-community.png";
import ASHOK_BUILDERS_RESIDENTIAL_COMMERCIAL from "./casestudyimages/CONSTRUCTIONS/ashok-builders-residential-and-commercial.png";
import GK_BUILDERS from "./casestudyimages/CONSTRUCTIONS/gk-builders.png";
import INDIAN_OIL_CORPORATION_LIMITED_FUEL from "./casestudyimages/CONSTRUCTIONS/indian-oil-corporation-limited-fuel.png";
import RAICHANDANI_MALL_HYDERABAD from "./casestudyimages/CONSTRUCTIONS/raichandani-mall-hyderabad.png";
import VASAVI_GROUP_HYDERABAD from "./casestudyimages/CONSTRUCTIONS/vasavi-group-hyderabad.png";

/* =========================
   DEFENCE
========================= */
import BORDER_SECURITY_FORCE from "./casestudyimages/Defence/border-security-force.png";

/* =========================
   EDUCATION
========================= */
import DELHI_PUBLIC_SCHOOL from "./casestudyimages/EDUCATION/delhi-public-school.png";
import GAUDIUM_SCHOOL from "./casestudyimages/EDUCATION/gaudium-school.png";
import JNTU_CAMPUS from "./casestudyimages/EDUCATION/jntu-campus.png";
import MHCET_EXAMINATIONS from "./casestudyimages/EDUCATION/mhcet-examinations.png";
import NALSAR_UNIVERSITY from "./casestudyimages/EDUCATION/nalsar-university.png";
import NEET_EXAMINATIONS from "./casestudyimages/EDUCATION/neet-examinations.png";
import STANLEY_COLLEGE from "./casestudyimages/EDUCATION/stanley-college.png";
import UNIVERSITY_OF_HYDERABAD from "./casestudyimages/EDUCATION/university-of-hyderabad.png";

/* =========================
   FORESTRY
========================= */
import KAZIRANGA_NATIONAL_PARK from "./casestudyimages/Forestry/kaziranga-national-park.png";
...
import MLC_ELECTIONS from "./casestudyimages/Government/mlc-elections.png";
import RAJ_BHAVAN from "./casestudyimages/Government/raj-bhavan.png";
import TELANGANA_ELECTIONS_2024 from "./casestudyimages/Government/telangana-elections-2024.png";
...
/* =========================
   HEALTH CARE
========================= */
import APOLLO from "./casestudyimages/HEALTH CARE/apollo.png";
import DIVIS_LAB from "./casestudyimages/HEALTH CARE/divis-lab.png";

/* =========================
   IT
========================= */
import ADD_A_SUBHEADING_500_X_500_PX from "./casestudyimages/IT/add-a-subheading-500x500px.png";
import DAZN_SOFTWARE from "./casestudyimages/IT/dazn-software.png";
import IVY_COMPU_TECH from "./casestudyimages/IT/ivy-compu-tech.png";

/* =========================
   MANUFACTURING
========================= */
import AMNS_INDIA_STEEL_PLANT from "./casestudyimages/manufacturing/amns-india-steel-plant.png";
import DAZZLE_SPORTS_FACILITY from "./casestudyimages/manufacturing/dazzle-sports-facility.png";
import INDIA_CEMENTS_HYDERABAD from "./casestudyimages/manufacturing/india-cements-hyderabad.png";
import NTTPS_VIJAYAWADA from "./casestudyimages/manufacturing/nttps-vijayawada.png";
import PRATISTHA_INDUSTRIES from "./casestudyimages/manufacturing/pratistha-industries.png";
import SITARAM_SPINNERS_PVT_LTD from "./casestudyimages/manufacturing/sitaram-spinners-pvt-ltd.png";
import TATA_POWER_OPERATIONAL_FACILITY from "./casestudyimages/manufacturing/tata-power-operational-facility.png";
import THYSSENKRUPP_INDUSTRIES_INDIA_PVT_LTD from "./casestudyimages/manufacturing/thyssenkrupp-industries-india-pvt-ltd.png";
import VIZAG_STEEL_PLANT from "./casestudyimages/manufacturing/vizag-steel-plant.png";
import YADADRI_THERMAL_POWER_STATION from "./casestudyimages/manufacturing/yadadri-thermal-power-station.png";

/* =========================
   MUNCIPALITY
========================= */
import IDA_BOLLARAM from "./casestudyimages/MUNCIPALITY/ida-bollaram.png";
import NELLORE_MUNCIPAL from "./casestudyimages/MUNCIPALITY/nellore-municipal.png";

/* =========================
   RESEARCH
========================= */
import ATOMIC_MINERALS_DIRECTORATE from "./casestudyimages/RESEARCH/atomic-minerals-directorate.png";
import CSIR_CCMB_HYDERABAD from "./casestudyimages/RESEARCH/csir-ccmb-hyderabad.png";
import DRDO_FACILITIES from "./casestudyimages/RESEARCH/drdo-facilities.png";

/* =========================
   TOURISM
========================= */
import KONDAGATTU_ANJANEYASWAMY_TEMPLE from "./casestudyimages/TOURISM/kondagattu-anjaneyaswamy-temple.png";
import SRIKALAHASTHI_TEMPLE from "./casestudyimages/TOURISM/srikalahasthi-temple.png";
import SRISAILAM from "./casestudyimages/TOURISM/srisailam.png";

/** Exported for Prestigious Government Projects section (homepage logos) */
export { KAZIRANGA_NATIONAL_PARK as PRESTIGIOUS_LOGO_KAZIRANGA, TELANGANA_INTER_BOARD_EXAMS as PRESTIGIOUS_LOGO_TGBIE };

export const SECTOR_META = {
  // education: { title: "Education", image: Img110017 },
  // examinations: { title: "Examinations", image: Img124911 },
  // healthcare: { title: "Healthcare", image: Img175332 },
  // banking: { title: "Banking", image: Img30848 },
  // industrial: { title: "Industrial", image: Img6677 },
  // government: { title: "Government", image: Img32382 },
  // religious: { title: "Religious", image: Img22891404 },
  // realestate: { title: "Real Estate", image: Img19106 },
  // retail: { title: "Retail", image: Img890 },
  // manufacturing: { title: "Manufacturing", image: Img293 },
  // research: { title: "Research", image: ImgCustom },
  // it: { title: "IT", image: Img293 }, // change if you want
  // miscellaneous: { title: "Miscellaneous", image: Img890 }, // change if you want
} as const;
...
interface CaseStudy {
  ...
  sector: string;
  sectorSlug: string;
  /** Optional year for timeline / our-projects display; if omitted, a default is derived from sector */
  year?: number;
}

export const CASE_STUDIES_BY_SECTOR: Record<string, CaseStudy[]> = {
  Education: [
    {
      id: 1,
      ...
      company: "NALSAR",
      avatar: NALSAR_UNIVERSITY,
      rating: 5,
      quote: "The CCTV surveillance installation provided a robust security system ensuring the safety of students, faculty, staff, and visitors across the campus.",
      challenges: [
    ...
    },
    {
      ...
      avatar: UNIVERSITY_OF_HYDERABAD,
      rating: 5,
      quote: "The IP-based CCTV surveillance system improved campus safety and supported administrative supervision across the large residential campus.",
      challenges: [
      ...
      sector: "Education",
      sectorSlug: "education",
      project_objective: "The objective was to install IP-based CCTV cameras across academic blocks, administrative offices, hostels, libraries, and main entry points to monitor activity, discourage unauthorized access, and support incident response.",
    },
    {
      id: 3,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: DELHI_PUBLIC_SCHOOL,
      rating: 5,
      quote: "The digital monitoring and RFID-based attendance system supported school administration and kept parents informed about their children’s daily movements.",
      challenges: [
      ...
      sector: "Education",
      sectorSlug: "education",
      project_objective: "The objective was to create a system that supported school administration, kept parents informed about their children’s daily movements, and helped staff manage attendance and reporting with ease. Brihaspathi Technologies was selected to develop and maintain these integrated solutions.",
    },
    {
      id: 4,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: STANLEY_COLLEGE,
      rating: 5,
      quote: "The campus surveillance system monitored high-traffic areas and maintained a safe learning environment for students and staff.",
      challenges: [
      ...
      slug: "stanley-college-of-engineering-and-technology-for-women",
      sector: "Education",
      sectorSlug: "education",
      project_objective: "The goal was to set up a CCTV system that could monitor high-traffic areas, outdoor spaces, and residential zones to maintain a safe and secure learning environment for students and staff. Brihaspathi Technologies was chosen to deliver and maintain a campus-wide surveillance system.",
    },
    {
      id: 5,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: JNTU_CAMPUS,
      rating: 5,
      quote: "The IP-based CCTV surveillance installation strengthened campus safety and supported administrative oversight across university facilities.",
      challenges: [
      ...
      slug: "jawaharlal-nehru-technological-university-jntu",
      sector: "Education",
      sectorSlug: "education",
      project_objective: "The objective was to install IP-based CCTV cameras across the university grounds, covering entrances, academic buildings, examination halls, corridors, parking zones, and student activity areas.",
    },
    {
      id: 6,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: GAUDIUM_SCHOOL,
      rating: 5,
      quote: "The IP camera-based student transport monitoring system addressed parent concerns and supported route and behavior management for the 90-bus fleet.",
      challenges: [
      ...
      slug: "the-gaudium-school",
      sector: "Education",
      sectorSlug: "education",
      project_objective: "Gaudium School aimed to improve student safety and transportation oversight by installing IP cameras across its fleet of 90 school buses. The goal was to monitor on-board activities during transit, address parent concerns regarding student travel, and support the transport team in route and behavior management. Brihaspathi Technologies was brought in to design and execute the mobile surveillance system tailored for moving vehicles.",
    },
  ],
  Examinations: [
    {
      ...
      avatar: NEET_EXAMINATIONS,
      rating: 5,
      quote: "The nationwide CCTV surveillance deployment supported transparency and maintained the integrity of the NEET examination process across thousands of centers.",
      challenges: [
      ...
      slug: "neet-examinations",
      sector: "Examinations",
      sectorSlug: "examinations",
      project_objective: "The objective was to provide real-time surveillance and video recording across thousands of centers to support transparency, discourage malpractice, and maintain the integrity of the examination process.",
    },
    {
      id: 8,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: MHCET_EXAMINATIONS,
      rating: 5,
      quote: "The CCTV surveillance deployment monitored exam proceedings and maintained integrity across Maharashtra's centers with 6000 cameras.",
      challenges: [
    ...
    },
    {
      ...
      avatar: TELANGANA_INTER_BOARD_EXAMS,
      rating: 5,
      quote: "Deployed 5,500+ IP cameras across 1,300+ government centers and 3,000+ Wi-Fi cameras in 700+ private centers for transparent monitoring.",
      challenges: [
      ...
      slug: "telangana-intermediate-board-exams-2025",
      sector: "Examinations",
      sectorSlug: "examinations",
      project_objective: "The goal was to build a strong monitoring system to reduce unfair practices and ensure transparency during exams.We deployed 5,500+ IP cameras across 1,300+ government exam centers. Additionally, 3,000+ Wi-Fi cameras were installed in 700+ private centers within a tight deadline.",
    },
  ],
  Healthcare: [
    {
      ...
      avatar: AROGYA_MITHRA_KIOSKS,
      rating: 5,
      quote: "Installed 1,435 CCTV cameras across 13 districts to secure kiosks and enhance operational security for public health services.",
      challenges: [
      ...
      slug: "aarogya-mithra-kiosks",
      sector: "Healthcare",
      sectorSlug: "healthcare",
      project_objective: "The project aimed to provide comprehensive security and monitoring for Dr. YSR Aarogyasri Aarogya Mithra Kiosks across 13 districts in Andhra Pradesh. It focused on ensuring kiosk safety, protecting public health services, and preventing illegal or disruptive activities. A total of 1,435 CCTV cameras were installed to strengthen monitoring and enhance operational security.",
    },
    {
      id: 11,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: APOLLO,
      rating: 5,
      quote: "Enhanced suite rooms and doctors’ rest areas with smart automation for lighting, air conditioning, and curtains, improving comfort and energy efficiency.",
      challenges: [
      ...
      sector: "Healthcare",
      sectorSlug: "healthcare",
      project_objective: "Apollo Hospital enhanced its suite rooms and doctors’ rest areas with smart automation for lighting, air conditioning, and curtains. This upgrade aimed to provide greater comfort, convenience, and energy efficiency while eliminating the need for manual switches. Brihaspathi Technologies designed and implemented a tailored automation solution to meet the hospital’s unique requirements.",
    },
  ],
  Banking: [
    {
      ...
      company: "APGB",
      avatar: ANDHARA_PRAGATHI_GRAMEENA_BANK,
      rating: 5,
      quote: "All critical areas of the bank’s operations, including customer and staff zones, are now under constant surveillance. With automated video recording in place, reliance on manual security checks was reduced, freeing up staff for other tasks.",
      challenges: [
      ...
      slug: "andhra-pragathi-grameena-bank",
      sector: "Banking",
      sectorSlug: "banking",
      project_objective: "Andhra Pragathi Grameena Bank (APGB), headquartered in Kadapa, needed a robust surveillance system to enhance security at its head office and branches. CCTV cameras were installed at critical points such as entry gates, staff areas, lockers, offices, and public zones to ensure safety and prevent unauthorized access. Brihaspathi Technologies managed the complete planning, supply, installation, and maintenance of the system.",
    },
    {
      id: 13,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: ANDHRA_PRADESH_STATE_CO_OPERATIVE_BANK_Ltd,
      rating: 5,
      quote: "The installation was completed successfully, meeting the bank’s expectations for visual coverage and monitoring. The surveillance system improved visibility into daily operations, helping both security teams and administrative staff.",
      challenges: [
      ...
      sector: "Banking",
      sectorSlug: "banking",
      project_objective: "The Andhra Pradesh State Co-operative Bank in Koti, Hyderabad, implemented a CCTV surveillance system to enhance safety and operational monitoring. The solution ensured complete visual coverage of key areas, including staff zones, secure rooms, and entry points. Brihaspathi Technologies handled the supply, installation, and maintenance to meet both daily security and long-term monitoring needs.",
    },
    {
      id: 53,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: BANK_OF_BARODA,
      rating: 5,
      quote: "Digital Visitor Management System for Bank of Baroda Branches",
      challenges: [
        "Different branches had unique layouts and entry procedures, requiring a flexible system adaptable to various setups.",
        "Physical logbooks were often incomplete, illegible, or not cross-checked, leading to gaps in visitor tracking.",
        "Staff had to manually confirm visits with concerned departments, which delayed approvals and affected visitor experience..",
      ],
      solutions: [
        "Visitors could register digitally at reception using a self-service terminal or staff-operated desktop. Information such as name, ID proof, mobile number, and meeting purpose was recorded.",
        "The system captured a visitor photo and printed a temporary badge with visit details and time of access.",
        "The system sent instant alerts to the host employee via SMS or email to approve or decline the visit.",
      ],
      results: [
        "Staff no longer needed to manually verify visitor information, improving efficiency and reducing wait times.",
        " Unauthorized or unexpected visits could be flagged and reviewed quickly with digital records and photo logs.",
        "Improved driver accountability and overall fleet management.",
      ],
      slug: "bank-of-baroda",
      sector: "Miscellaneous",
      sectorSlug: "miscellaneous",
      project_objective: "PSBCL manages wholesale and retail distribution of alcoholic beverages across Andhra Pradesh.To improve fleet visibility, a mobile-based GPS tracking system was introduced.It enables real-time monitoring, maintenance tracking, and driver performance management.",
    },
    {
      id: 14,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: KARUE_VYSHYA,
      rating: 5,
      quote: "All target branches were brought under a standardized burglar alarm system, deterring several attempted break-ins and enabling immediate responses without disrupting regular banking operations.",
      challenges: [
      ...
      sector: "Banking",
      sectorSlug: "banking",
      project_objective: "Karur Vysya Bank (KVB), a leading private sector bank in South India, sought a security alarm system to safeguard 70 of its branches from unauthorized access and theft. The solution needed to provide real-time alerts to security teams and branch managers, especially after banking hours. Brihaspathi Technologies was chosen to supply and install advanced burglar alarm systems across the selected locations.",
    },
    {
      id: 15,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      company: "TSCAB",
      avatar: TELANGANA_STATE_CO_OPERATIVE_BANK,
      rating: 5,
      quote: "IP CCTV cameras across branches improved monitoring of operational and sensitive areas, enabling centralized oversight and reducing transaction disputes.",
      challenges: [
      ...
      slug: "telangana-state-co-operative-bank",
      sector: "Banking",
      sectorSlug: "banking",
      project_objective: "Telangana State Co-operative Bank enhanced its security by deploying IP-based CCTV systems across all branches. The solution aimed to monitor daily operations, prevent unauthorized access, safeguard assets, and ensure safety for staff and customers. Brihaspathi Technologies implemented a uniform surveillance setup throughout the bank’s network in the state.",
    },
  ],
  Industrial: [
    {
      ...
      company: "IOCL",
      avatar: INDIAN_OIL_CORPORATION_LIMITED_FUEL,
      rating: 5,
      quote: "The IP-based CCTV solution covered internal and external zones for real-time monitoring by on-site security staff.",
      challenges: [
      ...
      slug: "indian-oil-corporation-limited-iocl",
      sector: "Industrial",
      sectorSlug: "industrial",
      project_objective: "The objective was to deploy a comprehensive IP-based CCTV solution that could cover all internal and external zones, including entry/exit points and parking areas, while allowing real-time monitoring by on-site security staff.",
    },
    {
      id: 17,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: DIVIS_LAB,
      rating: 5,
      quote: "Implemented a CCTV surveillance system to protect valuable assets, staff, and sensitive materials with comprehensive coverage across the facility.",
      challenges: [
      ...
      sector: "Industrial",
      sectorSlug: "industrial",
      project_objective: "Divi’s Laboratories, a leading pharmaceutical company, implemented a CCTV surveillance system to strengthen the safety and security of its premises. The system was designed to protect valuable assets, staff, and sensitive materials through comprehensive coverage of both indoor and outdoor areas. It enabled real-time monitoring and recording of activities across multiple locations within the facility.",
    },
    {
      id: 18,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: INDIA_CEMENTS_HYDERABAD,
      rating: 5,
      quote: "Implemented a comprehensive CCTV surveillance system to provide clear visibility across critical areas and enhance centralized control.",
      challenges: [
      ...
      sector: "Industrial",
      sectorSlug: "industrial",
      project_objective: "India Cements sought to increase security and monitoring at their Hyderabad facility. The goal was to put in place a comprehensive surveillance system that would provide clear visibility across critical areas like entry points, staff areas, and operational zones, while also offering centralized control over the entire setup.",
    },
    {
      id: 19,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: THYSSENKRUPP_INDUSTRIES_INDIA_PVT_LTD,
      rating: 5,
      quote: "Installed a robust surveillance system to secure industrial plant operations and monitor critical zones effectively.",
      challenges: [
      ...
      slug: "thyssenkrupp-industries",
      sector: "Industrial",
      sectorSlug: "industrial",
      project_objective: "Thyssenkrupp Industries India Pvt. Ltd. has a location in Cherlapalli, Hyderabad. It's situated in the IDA Phase 2 area, near HCL. The company is known for its work in plant engineering, offering services like design, manufacture, supply, construction, and maintenance of industrial plants and systems. They also have a significant presence in the elevator repair and services sector in Cherlapalli.",
    },
    {
      id: 20,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: VIZAG_STEEL_PLANT,
      rating: 5,
      quote: "Deployed an integrated CCTV system under the 'Manakosam' initiative to ensure continuous monitoring and a safer environment for workers and visitors.",
      challenges: [
      ...
      slug: "rashtriya-ispat-nigam-ltd-rinl",
      sector: "Industrial",
      sectorSlug: "industrial",
      project_objective: "The project aimed to implement a comprehensive CCTV system at RINL Visakhapatnam under the “Manakosam” initiative with City Police, ensuring continuous monitoring, enhanced security, asset protection, and a safer environment for workers, families, and visitors.",
    },
    {
      id: 21,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      company: "Tata Power",
      avatar: TATA_POWER_OPERATIONAL_FACILITY,
      rating: 5,
      quote: "Implemented an IP-based CCTV system for 24/7 monitoring across control rooms, power units, and staff zones to enhance safety and security.",
      challenges: [
      ...
      sector: "Industrial",
      sectorSlug: "industrial",
      project_objective: "Tata Power implemented an IP-based CCTV system across control rooms, power units, perimeters, gates, and staff zones to ensure 24/7 monitoring, enhance safety, and prevent unauthorized access.",
    },
    {
      id: 22,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: PRATISTHA_INDUSTRIES,
      rating: 5,
      quote: "Installed 125 IP CCTV cameras to enhance security, monitor production, and reduce risks across factory floors and critical areas.",
      challenges: [
      ...
      slug: "prathista-industries",
      sector: "Industrial",
      sectorSlug: "industrial",
      project_objective: "Pratistha Industries partnered with Brihaspathi Technologies to install 125 IP CCTV cameras across entry points, factory floors, warehouses, loading bays, admin areas, and parking lots to enhance security, monitor production, and reduce risks.",
    },
    {
      id: 23,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: AMNS_INDIA_STEEL_PLANT,
      rating: 5,
      quote: "Deployed a full-fledged CCTV surveillance system to ensure worker safety and monitor activities across the steel plant’s vast premises.",
      challenges: [
    ...
    },
    {
      ...
      avatar: NTTPS_VIJAYAWADA,
      rating: 5,
      quote: "Enhanced security and monitoring across the 237.7-acre facility with a CCTV system covering critical operational and administrative areas.",
      challenges: [
      ...
      slug: "dr-narla-tata-rao-thermal-power-station",
      sector: "Industrial",
      sectorSlug: "industrial",
      project_objective: "The CCTV surveillance system at Dr. Narla Tata Rao Thermal Power Station (NTTPS) was installed to enhance security and monitoring across its 237.7-acre facility. Covering critical areas like operations, transport systems, admin blocks, parking, and grounds, the project safeguards assets, employees, and surrounding communities while supporting industrial safety and environmental protection.",
    },
    {
      id: 25,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: YADADRI_THERMAL_POWER_STATION,
      rating: 5,
      quote: "Deployed a CCTV surveillance system for wide-area monitoring across key operational zones and access points to ensure safety and compliance.",
      challenges: [
      ...
      slug: "bhel-yadadri-thermal-power-station",
      sector: "Industrial",
      sectorSlug: "industrial",
      project_objective: "The aim of the project was to implement a CCTV surveillance system that could provide wide-area monitoring across the BHEL Yadadri Thermal Power Station. The organization required a security solution that would help in overseeing key operational zones, staff areas, and access points to maintain safety and regulatory compliance.",
    },
    {
      id: 26,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: IDA_BOLLARAM,
      rating: 5,
      quote: "Established a comprehensive surveillance and alert system to monitor unauthorized activities and ensure public safety across a 12-kilometer industrial zone.",
      challenges: [
      ...
      sector: "Industrial",
      sectorSlug: "industrial",
      project_objective: "IDA Bollaram, a major industrial development area, required a structured surveillance and alert system to monitor unauthorized activities, vehicular movement, theft incidents, and general public safety across its 12-kilometer span. ",
    },
  ],
  Government: [
    {
    ...
    },
    {
      id: 52,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      name: "Bihar Legislative Assembly Elections 2025: Live Web Streaming & Surveillance Project",
      role: "BIHAR Election Commission",
      city: "Bihar",

      company: "Election Commission",
      avatar: BIHAR_ELECTIONS,
      rating: 5,
      quote: "Over 181,000 cameras installed with near 100% uptime across polling locations, enabling comprehensive monitoring and recording.",
      challenges: [
        "Limited internet connectivity in remote and rural polling station locations",
        "Physical access issues such as locked premises, and school or BLO unavailability.",
        "Ensuring data privacy, preventing unauthorized data access, and maintaining legal compliance throughout the process.",
      ],
      solutions: [
        "Establishment of centralized help desks and district-level coordinators for seamless workflow and rapid issue escalation.",
        "Facilitate real-time oversight and rapid issue escalation for all critical activities at over 90,712 polling stations and 243 counting centres",
        "Robust monitoring infrastructure with backup connectivity options.",
      ],
      results: [
        "Over 181,000 cameras installed with near 100% uptime across polling locations, enabling comprehensive monitoring and recording.",
        "Real-time resolution of connectivity, access, and manpower challenges, minimizing poll disruptions.",
        "Zero re-polls due to technical failures, as cited by the Election Commission.",
      ],
      slug: "bihar-legislative-assembly-elections-2025",
      sector: "Government",
      sectorSlug: "government",
      project_objective: "Enable real-time audio-video live streaming across all polling stations, counting centres, and check posts in Bihar for the 2025 Legislative Assembly elections, ensuring complete transparency, secure dual storage, and centralized monitoring through a Command Control Center for instant oversight and swift action.",
    },
    {
      id: 28,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: MLC_ELECTIONS,
      rating: 5,
      quote: "Deployed 2,132 cameras at key locations across major districts to ensure safe and transparent polling with real-time monitoring.",
      challenges: [
      ...
      slug: "ap-graduate-constituency-elections-2025",
      sector: "Government",
      sectorSlug: "government",
      project_objective: "To ensure safe and transparent polling, 2,132 cameras were set up at key locations.The surveillance covered major districts including Srikakulam, Vizianagaram, Visakhapatnam, Kakinada, Guntur, and Krishna.This enabled real-time monitoring and effective control of polling activities.",
    },
    {
      id: 29,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: VIZAG_CITY_POLICE_COMMISSIONERATE,
      rating: 5,
      quote: "Enhanced security infrastructure with robust CCTV system for complete visual coverage across critical areas of the Steel Plant Police Station jurisdiction.",
      challenges: [
      ...
      slug: "visakhapatnam-city-police-commissionerate",
      sector: "Government",
      sectorSlug: "government",
      project_objective: "The project aimed to enhance the security infrastructure of Visakhapatnam City Police Commissionerate with a robust CCTV surveillance system. Supported under the RINL-CSR initiative, it ensured complete visual coverage across critical areas of the Steel Plant Police Station jurisdiction. ",
    },
    {
      id: 30,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: TELANGANA_HIGH_COURT,
      rating: 5,
      quote: "Modernized courtroom infrastructure with live streaming, video conferencing, and enhanced security for transparency and seamless communication.",
      challenges: [
      ...
      sector: "Government",
      sectorSlug: "government",
      project_objective: "The Telangana High Court sought to enhance transparency by modernizing courtroom infrastructure with live streaming and video conferencing. It also aimed to strengthen security, enable seamless remote communication, and improve courtroom audio clarity. Brihaspathi Technologies delivered a comprehensive solution to meet these evolving needs.",
    },
    {
      id: 32,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: RAJ_BHAVAN,
      rating: 5,
      quote: "Provided comprehensive CCTV security across Staff Quarters and Community Hall to ensure safety for residents, dignitaries, and guests.",
      challenges: [
      ...
      slug: "raj-bhavan-hyderabad",
      sector: "Government",
      sectorSlug: "government",
      project_objective: "The objective of the CCTV installation project at Raj Bhavan Hyderabad was to provide comprehensive security and surveillance across both the Staff Quarters and the Community Hall. The goal was to ensure the safety of residents, dignitaries, and guests by placing a well-coordinated CCTV system throughout the premises",
    },
    {
      id: 33,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: TELANGANA_ELECTIONS_2024,
      rating: 5,
      quote: "Designed and deployed 4G IP-based surveillance across 16 districts for polling stations, EVM strong rooms, and administrative offices.",
      challenges: [
    ...
    },
    {
      ...
      avatar: NELLORE_MUNCIPAL,
      rating: 5,
      quote: "Implemented a GPS-based vehicle tracking and fleet monitoring system to enhance efficiency in sanitation, waste collection, and civic maintenance operations.",
      challenges: [
      ...
      slug: "nellore-municipal-corporation",
      sector: "Government",
      sectorSlug: "government",
      project_objective: "Nelore Municipal Corporation needed a reliable system to monitor the movement and utilization of its fleet, primarily used for sanitation, waste colection, and civic maintenance. The aim was to introduce a vehicle tracking solution that would support daily operations.",
    },
    {
      id: 35,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: ATOMIC_MINERALS_DIRECTORATE,
      rating: 5,
      quote: "Deployed a robust security and communication system to secure operations at AMD’s Hyderabad headquarters and Bangalore facility.",
      challenges: [
      ...
      slug: "atomic-minerals-directorate-amd",
      sector: "Government",
      sectorSlug: "government",
      project_objective: "The Atomic Minerals Directorate for Exploration and Research (AMD), operating under the Department of Atomic Energy, required a robust security and communication system for its headquarters in Hyderabad and its facility in Bangalore.",
    },
    {
      id: 36,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: DRDO_FACILITIES,
      rating: 5,
      quote: "Implemented an Aadhaar-enabled biometric attendance system to standardize and secure workforce tracking across DRDO facilities.",
      challenges: [
      ...
      sector: "Government",
      sectorSlug: "government",
      project_objective: "The Defense Research and Development Organization (DRDO) required a secure and standardized attendance system for its workforce. The objective was to install Aadhaar-enabled biometric devices .",
    },
  ],
  Religious: [
    {
      ...
      avatar: KONDAGATTU_ANJANEYASWAMY_TEMPLE,
      rating: 5,
      quote: "Implemented an AI-enabled IP-based surveillance system to support local authorities in maintaining security at the historic temple complex.",
      challenges: [
      ...
      slug: "kondagattu-anjaneya-swamy-temple-1",
      sector: "Religious",
      sectorSlug: "religious",
      project_objective: "The main goal of the project was to set up a reliable CCTV surveillance system at the Kondagattu Anjaneya Swamy Temple in Mallial Mandal, Jagtial District, Telangana. The system was intended to support local authorities in maintaining security",
    },
    {
      id: 38,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: SRIKALAHASTHI_TEMPLE,
      rating: 5,
      quote: "Deployed a reliable IP CCTV surveillance system to enhance crowd control, secure temple assets, and ensure safety for devotees and staff.",
      challenges: [
      ...
      sector: "Religious",
      sectorSlug: "religious",
      project_objective: "Srikalahasthi Temple, a prominent spiritual site in Andhra Pradesh, needed a reliable surveillance system to support crowd control, secure temple assets, monitor daily activities, and improve the overall safety of devotees and staff.",
    },
    {
      id: 40,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: SRISAILAM,
      rating: 5,
      quote: "Implemented a large-scale IP-based CCTV surveillance system to improve overall security and crowd management for thousands of daily devotees.",
      challenges: [
      ...
      sector: "Religious",
      sectorSlug: "religious",
      project_objective: "SriSaila Devasthanam, a significant pilgrimage center in Srisailam, Kurnool, required a large-scale CCTV surveillance system to improve overall security and crowd management. With thousands of devotees visiting the temple daily, the objective was to establish a centralized IP-based surveillance system. ",
    },
  ],
  RealEstate: [
    {
      ...
      avatar: ANUHAR_HOMES_RESIDENTIAL_COMMUNITY,
      rating: 5,
      quote: "Installed 150 IP CCTV cameras to improve day-to-day oversight and support quick response to any incidents.",
      challenges: [
      ...
      project_objective: "The goal was to install 150 IP CCTV cameras across the property to improve day-to-day oversight and support quick response to any incidents. Brihaspathi Technologies was engaged to plan and execute this surveillance setup",
    },
    {
      id: 42,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: ASHOK_BUILDERS_RESIDENTIAL_COMMERCIAL,
      rating: 5,
      quote: "IP CCTV cameras installed across key zones to reduce unauthorized access and improve site safety during construction and post-handover phases.",
      challenges: [
      ...
      slug: "ashoka-builders",
      sector: "RealEstate",
      sectorSlug: "realestate",
      project_objective: " The objective was to install IP CCTV cameras across key zones within the project sites to help reduce unauthorized access, track ongoing activities, and improve site safety during both the construction and post-handover phases.",
    },
    {
      id: 43,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: VASAVI_GROUP_HYDERABAD,
      rating: 5,
      quote: "Integrated 50 IP CCTV cameras and smart access control setup for staff entry management, visitor tracking, and overall site monitoring.",
      challenges: [
      ...
      sector: "RealEstate",
      sectorSlug: "realestate",
      project_objective: "The objective was to install 50 IP CCTV cameras along with a smart access control setup for staff entry management, visitor tracking, and overall site monitoring across its office and residential sites.",
    },
  ],
  Retail: [
    {
      ...
      avatar: RAICHANDANI_MALL_HYDERABAD,
      rating: 5,
      quote: "The comprehensive IP-based CCTV solution covered all internal and external zones, enabling real-time monitoring by on-site security staff.",
      challenges: [
    ...
    },
    {
      ...
      avatar: GK_BUILDERS,
      rating: 5,
      quote: "CCTV network installed to improve overall visibility, support daily monitoring, and address potential safety concerns within the facility.",
      challenges: [
      ...
      sector: "Retail",
      sectorSlug: "retail",
      project_objective: "The objective was to install a CCTV network that would improve overall visibility, support daily monitoring, and help address potential safety concerns within the facility.",
    },
  ],
  Manufacturing: [
    {
      ...
      avatar: DAZZLE_SPORTS_FACILITY,
      rating: 5,
      quote: "Installed 100+ IP CCTV cameras to secure indoor and outdoor zones, manage crowds, and ensure safety across the facility.",
      challenges: [
      ...
      slug: "dazzle-sports-facility",
      sector: "Manufacturing",
      sectorSlug: "manufacturing",
      project_objective: "Dazzle Sports needed a reliable surveillance system to secure indoor and outdoor zones, manage crowds, and ensure safety.Brihaspathi Technologies installed 100+ IP CCTV cameras, enhancing visibility and control across the entire facility.",
    },
    {
      id: 47,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      avatar: SITARAM_SPINNERS_PVT_LTD,
      rating: 5,
      quote: "Implemented a surveillance system to improve safety, track vehicle movements, and monitor sensitive areas like cash transaction zones.",
      challenges: [
      ...
      slug: "sitaram-spinners",
      sector: "Manufacturing",
      sectorSlug: "manufacturing",
      project_objective: "Sitaram Spinners Pvt. Ltd., a leading name in yarn manufacturing, sought to create a secure and monitored environment within its production facility. The goal was to improve surveillance across the premises, ensure the safety of workers, track vehicle movements, and keep an eye on sensitive areas such as cash transaction zones and storage units.",
    },
  ],
  Research: [
    {
      ...
      avatar: CSIR_CCMB_HYDERABAD,
      rating: 5,
      quote: "Upgraded security with a comprehensive surveillance system to monitor key areas across the main campus and residential quarters.",
      challenges: [
      ...
      sector: "Research",
      sectorSlug: "research",
      project_objective: "The objective of this project was to install a security system that would allow the CSIR - Centre for Cellular and Molecular Biology to monitor key areas across its main campus and residential quarters.",
    },
  ],
  IT: [
    {
      ...
      avatar: IVY_COMPU_TECH,
      rating: 5,
      quote: "Installed 150 IP CCTV cameras to enhance security, safeguard employees, and protect assets across IVY Compu Tech's premises.",
      challenges: [
      ...
      sector: "IT",
      sectorSlug: "it",
      project_objective: "IVY Compu Tech, a Hyderabad-based IT and electronics firm, needed a strong surveillance system to secure its premises and safeguard employees and assets.Brihaspathi Technologies installed 150 IP CCTV cameras across key areas, enhancing monitoring, safety, and incident response.",
    },
  ],
  Miscellaneous: [
    {
      ...
      avatar: KAZIRANGA_NATIONAL_PARK,
      rating: 5,
      quote: "Implemented a CCTV surveillance system to enhance safety and monitoring, focusing on tracking vehicular movement across animal corridors and ensuring better oversight of ecological and visitor-sensitive zones.",
      challenges: [
      ...
      sector: "Miscellaneous",
      sectorSlug: "miscellaneous",
      project_objective: "Kaziranga National Park in Assam implemented a CCTV surveillance system to enhance safety and monitoring within its premises. The project focused on tracking vehicular movement across animal corridors while ensuring better oversight of ecological and visitor-sensitive zones. This initiative aimed to strengthen both conservation efforts and visitor management.",
    },
    {
      id: 51,
      pdf: "/case studies/BANK/Andhra Pragathi Grameena Bank.pdf",
      ...
      company: "APSBCL",
      avatar: APSBCL_OPERATIONS,
      rating: 5,
      quote: "Introduced mobile-based GPS tracking for real-time fleet visibility, maintenance, and driver performance management.",
      challenges: [
...
export function getAllSectors() {
  ...
  return Object.values(CASE_STUDIES_BY_SECTOR)
    .flat()
    .filter((c) => {
      if (seen.has(c.sectorSlug)) return false;
      seen.add(c.sectorSlug);
      return true;
    })
    .map((c) => ({
      name: c.sector,
...
export function getAllCaseStudies() {
  return Object.values(CASE_STUDIES_BY_SECTOR).flat();
}

export function getCaseStudiesBySector(sectorSlug: string) {
  return Object.values(CASE_STUDIES_BY_SECTOR)
    .flat()
    .filter((c) => c.sectorSlug === sectorSlug);
}

export function getCaseStudy(sectorSlug: string, caseSlug: string) {
  return Object.values(CASE_STUDIES_BY_SECTOR)
    .flat()
    .find(
      (c) => c.sectorSlug === sectorSlug && c.slug === caseSlug
    );
}