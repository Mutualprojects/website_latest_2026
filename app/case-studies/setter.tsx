      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar">
        <div className="space-y-2">
          <button
            ...
            className={`w-full px-4 py-4 flex items-center justify-between rounded-xl ${selectedSector === "all"
          ...
          >
            <div className="flex items-center gap-3">
              <div
                className={`w-11 h-11 rounded-lg flex items-center justify-center ${selectedSector === "all"
                  ? "bg-white/20"
                  : "bg-[#07518a]/10"
                  }`}
              >
                <Grid3x3
                  className={`w-5 h-5 ${selectedSector === "all" ? "text-white" : "text-[#07518a]"
                    }`}
                />
              </div>
            ...
            <span
              className={`text-xs font-bold px-3 py-1.5 rounded-full ${selectedSector === "all"
            ...
            {sectors.map((sector) => {
              ...
              return (
                <button
                  ...
                  className={`w-full px-4 py-3.5 flex items-center justify-between rounded-xl ${isActive
                    ? "bg-gradient-to-r from-[#07518a] to-[#064a7d] text-white shadow-lg"
                    : "bg-white hover:bg-gray-50 text-gray-700 shadow-sm"
                    }`}
                >
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-10 h-10 rounded-lg flex items-center justify-center ${isActive ? "bg-white/20" : "bg-[#07518a]/10"
                        }`}
                    >
                      <Icon
                        className={`w-5 h-5 ${isActive ? "text-white" : "text-[#07518a]"
                          }`}
                      />
                    </div>
